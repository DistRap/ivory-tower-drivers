...
module Ivory.Tower.Drivers.Magnetometer.HMC5883L.Regs where
...
gainScale :: Fractional a => Gain -> a
gainScale gain = case gain of
  LSBGauss1370 -> 100 / 1370
  LSBGauss1090 -> 100 / 1090
  LSBGauss820  -> 100 / 820
  LSBGauss660  -> 100 / 660
  LSBGauss440  -> 100 / 440
  LSBGauss390  -> 100 / 390
