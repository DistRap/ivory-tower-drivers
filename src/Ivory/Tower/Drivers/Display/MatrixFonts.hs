...
module Ivory.Tower.Drivers.Display.MatrixFonts where
...
type Sprite = 'Array 8 ('Stored Uint8)
type Font = 'Array 256 (Sprite)

mkFont :: [[Integer]] -> Init Font
mkFont = iarray . map (\cols -> iarray (map (ival . fromInteger) cols)) 

cp437Font :: Init Font
cp437Font = mkFont cp437FontData

sinclairsFont :: Init Font
sinclairsFont = mkFont sinclairsFontData

lcdFont :: Init Font
lcdFont = mkFont lcdFontData

tinyFont :: Init Font
tinyFont = mkFont tinyFontData


cp437FontData :: [[Integer]]
cp437FontData = [
